  ...
  return (
    <section id="final-cta" className="py-12 lg:py-24 bg-card">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-headline mb-6">Você tem duas opções agora:</h2>
        ...
        <Button asChild size="lg" className="font-headline text-lg sm:text-xl animate-pulse w-full sm:w-auto">
